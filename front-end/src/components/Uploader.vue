  ...
  <div class="modal-mask">
    <div class="modal-container">
      <form class="pure-form" @submit.prevent="upload">
        ...
        <fieldset>
          <input v-model="numDinos" placeholder="number of dinos" type="number"/>
        </fieldset>
        <fieldset>
          <input v-model="donation" placeholder="price per month" type="number"/>
        </fieldset>
        <fieldset>
  ...
  chooseImage() {
    ...
    async upload() {
      try {
        ...
        formData.append('numDinos', this.numDinos);
        formData.append('donation', this.donation);
